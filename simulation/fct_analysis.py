...
import sys
fct_f = open("./experiment-results/hpcc/fat/25G_30L/0.1s/dynamic_u0.45_FN_70/fct.txt")
out_f = open("./experiment-results/hpcc/fat/25G_30L/0.1s/dynamic_u0.45_FN_70/fct_ana.txt", "w")
