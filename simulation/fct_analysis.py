...
import sys
fct_f = open("./experiment-results/hpcc/fat/25G_50L/0.1s/dynamic_u0.6/fct.txt")
out_f = open("./experiment-results/hpcc/fat/25G_50L/0.1s/dynamic_u0.6/fct_ana.txt", "w")
