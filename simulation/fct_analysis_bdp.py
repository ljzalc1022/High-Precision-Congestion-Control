...
import sys
fct_f = open("./experiment-results/hpcc/fat/25G_30L/0.01s/dynamic_u0.45_exp2/fct.txt")
out_f = open("./experiment-results/hpcc/fat/25G_30L/0.01s/dynamic_u0.45_exp2/fct_ana_bdp.txt", "w")

N = 3
partition_name = ["378KB", "2MB", "10MB"]
partition_point = [378000, 2000000, 10000000]
partition_arrays = [[], [], [], [], []]
