...
if __name__ == "__main__":
    ...
    data = pd.read_csv("./experiment-results/hpcc/fat/25G_30L/0.1s/baseline/fct_pure.txt",
                       header=None,
                       names=["flow_size", "FCT"],
                       skiprows=[0],
    ...
    data = pd.read_csv("./experiment-results/hpcc/fat/25G_30L/0.1s/dynamic_u0.90_FP_70/fct_pure.txt",
                       header=None,
                       names=["flow_size", "FCT"],
                       skiprows=[0],
                       delim_whitespace=True)
    ...
    # plt.savefig("exp5_HPCC_relativeFCT_load50_a90.pdf")
    # plt.savefig("qscheduling_HPCC_relativeFCT_load50_a90.pdf")
    plt.savefig("exp6_HPCC_relativeFCT_load30_a90_FP30.pdf")
