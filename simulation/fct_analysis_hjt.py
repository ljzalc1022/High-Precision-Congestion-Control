...
import sys
fct_f = open("./experiment-results/hpcc/fat/25G_30L/0.1s/baseline/fct.txt")
out_f = open("./experiment-results/hpcc/fat/25G_30L/0.1s/baseline/fct_ana_hjt.txt", "w")

N = 2
partition_name = ["100KB", "5MB"]
partition_point = [100000, 5000000]
partition_arrays = [[], [], [], [], []]
